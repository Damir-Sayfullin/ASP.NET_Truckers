...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="whitefont">
        ...
        <p><b>Функции:</b> авторизация логиста или водителя. Панель управления зависит от должности. Источником данные о пользователях и грузах является база данных, расположенная в папке проекта <i>data/TruckersDB.mdb</i>.</p>
        <ul>
